...
@TeleOp
public class TestSpecimenHang extends LinearOpMode {
        ...
        while(opModeIsActive()){
            AZUtil.runInParallel(new Runnable() {
                ...
                public void run() {
                    ...
                    if( gamepad1.b){
                        specimenTool.gripper.turnWristRight();
                    }
                    if(gamepad1.y) {
                        specimenTool.gripper.raiseElbow();
                    }

                    if(gamepad1.x) {
                        specimenTool.gripper.lowerElbow();
                    }
                    if(gamepad1.a) {
                        specimenTool.gripper.turnWristLeft();
                    }
