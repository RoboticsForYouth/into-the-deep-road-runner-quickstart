    ...
    private void addActions() {
        ...
        sampleTwoCollectAction = new Action() {
            ...
            public boolean run(@NonNull TelemetryPacket telemetryPacket) {
                ...
                specimenTool.autoCollectAndWait(EnhancedClaw.WRIST_POS.AUTO_PICKUP_SAMPLE_ONE);
        ...
        sampleThreeCollectAction = new Action() {
            ...
            public boolean run(@NonNull TelemetryPacket telemetryPacket) {
                ...
                specimenTool.autoCollectAndWait(EnhancedClaw.WRIST_POS.AUTO_PICKUP_SAMPLE_TWO);
